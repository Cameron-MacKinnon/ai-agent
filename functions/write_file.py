...
schema_write_file = types.FunctionDeclaration(
    name="write_file",
    description="Opens and writes to a file in a specified directory relative to the working directory",
    parameters=types.Schema(
        ...
        properties={
            ...
            "content": types.Schema(
                type=types.Type.STRING,
                description="String of text to write to the given file",
            ),
        },
